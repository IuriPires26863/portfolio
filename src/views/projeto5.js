      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha5/"
            ...
            <div class="row">
              <div class="col-md-12 blog-main">
                <div class="Data">
                  ...
                  <hr />
                  <p>
                  In this project, we learned to use sounds and video. 
                  We created a script to serve as a video player and added sounds to elements with the necessary 
                  attention to ensure that they do not start playing at the beginning of the project, but rather when desired.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
