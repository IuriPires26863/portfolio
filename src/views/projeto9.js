      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha9/"
...
In this project, we learned to change the state of an element over time using scripts. 
We created a script that displayed an element for a few seconds, then hid it and showed another random element. 
This allowed us to create a game where we had to click on an element, and if we missed, we lost points. 
At the end, it displayed our score.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
