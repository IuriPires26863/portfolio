      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha2/"
            ...
            <div class="row">
              <div class="col-md-12 blog-main">
                <div class="Data">
                  ...
                  <hr />
                  <p>
                  In this project, we were introduced to simple animations. 
                  More specifically, we learned how to change the properties of an element in the project so that it appears and disappears as we want. 
                  We also learned how to set this animation in an infinite loop.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
