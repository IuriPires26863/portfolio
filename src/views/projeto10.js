      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha10/"
            ...
            <div class="row">
              <div class="col-md-12 blog-main">
                <div class="Data">
                  ...
                  <hr />
                  <p>
                  In this project, we once again used a script that hides elements but this time makes them appear when clicked, and checks if they match another. 
                  This method allowed us to create a memory game where we have to check if two cards have the same image when they are facing down. 
                  At the end, it shows the time it took us to find all the pairs.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
