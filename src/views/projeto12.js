          ...
          <main role="main" className="mx-auto col-10">
            <div class="row">
              <div class="col-md-12 blog-main">
                <div class="Data">
                  <h1 class="title">Aplicação Educacional e Lúdica</h1>
                  <div className="d-flex justify-content-between">
                    <div class="mt-5 d-flex col-6 px-0">
                      <h3 className="my-auto">Date:</h3>
                      <p className="mx-3 my-auto">15/06/2024</p>
                    </div>
                  ...
                  <hr />
                  <p>
                  This is a developing project with the goal of teaching children about environmental sustainability in a fun and educational way. 
                  For this, we have chosen several themes about environmental 
                  sustainability and need to create educational content for them, including a game for each theme with 3 levels of difficulty.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
