      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha8/"
...
In this project, we were introduced to the concept of drag and drop. 
In a game context again, we introduced a script that allows dragging pieces to a designated spot in an attempt to complete a puzzle. 
At the end, it presents our score.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
