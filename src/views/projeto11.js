      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26366/buildquiosque/"
...
The objective of this project is to create an engaging and informative experience that appeals to all members of the group. 
To achieve this, the software used in the execution of this kiosk was Unity (a versatile and powerful platform for game development 
and the creation of interactive content in 2D, 3D, virtual reality, and augmented reality).
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
