      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha7/"
            ...
            <div class="row">
              <div class="col-md-12 blog-main">
                <div class="Data">
                  ...
                  <hr />
                  <p>
                  In this project, we advanced a bit in managing scenes through scripts and also introduced the concept of points through scripts. 
                  Using scripts, we created a quiz game where we had to get the correct answer to move on to the next scene, and if we got it wrong, the game would end, and we would have to try again. 
                  At the end, it presented our results.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
