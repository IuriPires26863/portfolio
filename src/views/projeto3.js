      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha3/"
            ...
            <div class="row">
              <div class="col-md-12 blog-main">
                <div class="Data">
                  ...
                  <hr />
                  <p>
                  In this project, we advanced further with the animations we learned to create. 
                  We used the same appear animation, this time with a fade-in effect, and we were 
                  also introduced to rotation and position animations for some elements.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
