      ...
      <html>
        ...
        <body>
          ...
          <div class="HeroP">
            <iframe
              className="col-12"
              src="http://193.137.7.33/~aluno26863/ficha1/"
                ...
                <div class="Data">
                  ...
                  <div className="d-flex justify-content-between">
                    <div class="mt-5 d-flex col-6 px-0">
                      ...
                      <p className="mx-3 my-auto">27/02/2024</p>
                    </div>
                  ...
                  <hr />
                  <p>
                  This project was designed to introduce students to the Unity platform. We started by creating a new project. 
                  We were introduced to the concept of the canvas and learned how to add and edit content within the platform in a basic way. 
                  The project is static, so it does not involve any type of animation or interaction.
                  </p>
                  <hr />
                  <h2>Tools Used</h2>
